...
export default function DesktopSidebar() {
    ...
    return (
        <aside className="lg:flex w-[472px] shrink-0 p-6 flex-col justify-between border rounded-2xl h-fit md:sticky top-10 bg-white dark:bg-[#1a1a1a] border-gray-200 dark:border-gray-800">
            <div>
                <div className='flex items-center justify-between mb-4'>
                    <div className='flex gap-2'>
                        <Image src={Logo} alt='Logo' className='w-24 rounded-2xl object-cover' width={96} height={96} />
                        <div>
                            <div className="text-base text-gray-600 dark:text-gray-400">Hi! I’m</div>
                            <h1 className="text-4xl font-bold text-gray-900 dark:text-white leading-tight">Moch. Ridho Kurniawan</h1>
